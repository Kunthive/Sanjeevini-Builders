...
// Custom SVG icons to replace lucide-react for better compatibility
const defaultIconProps: Partial<React.SVGProps<SVGSVGElement>> = {
  width: 20,
  height: 20,
  strokeWidth: 1.8,
  role: "img",
...
export const Icons = {
  ...
  Linkedin: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...defaultIconProps} {...props}>
  ...
  Instagram: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...defaultIconProps} {...props}>
      <path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.117.6c-.588.227-.975.478-1.402.905-.423.423-.678.81-.905 1.402-.267.788-.468 1.658-.53 2.936C1.031 8.333 1.016 8.74 1.016 12s.015 3.667.072 4.947c.062 1.277.263 2.148.53 2.936.227.588.478.975.905 1.402.423.423.814.678 1.402.905.788.267 1.655.468 2.934.53 1.28.057 1.687.072 4.947.072s3.667-.015 4.947-.072c1.277-.062 2.148-.263 2.936-.53.588-.227.975-.478 1.402-.905.423-.423.678-.814.905-1.402.267-.788.468-1.655.53-2.934.057-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.062-1.277-.263-2.148-.53-2.936-.227-.588-.478-.975-.905-1.402-.423-.423-.814-.678-1.402-.905-.788-.267-1.655-.468-2.934-.53C15.667.048 15.26.035 12 .035zm0 2.16c3.203 0 3.585.009 4.849.070 1.171.054 1.805.244 2.227.408.56.217.96.477 1.382.896.419.42.679.822.896 1.381.164.422.354 1.057.408 2.227.061 1.264.07 1.646.07 4.849s-.009 3.585-.07 4.849c-.054 1.171-.244 1.805-.408 2.227-.217.56-.477.96-.896 1.382-.42.419-.822.679-1.381.896-.422.164-1.057.354-2.227.408-1.264.061-1.646.07-4.849.07s-3.585-.009-4.849-.07c-1.171-.054-1.805-.244-2.227-.408-.56-.217-.96-.477-1.382-.896-.419-.42-.679-.822-.896-1.381-.164-.422-.354-1.057-.408-2.227-.061-1.264-.07-1.646-.07-4.849s.009-3.585.07-4.849c.054-1.171.244-1.805.408-2.227.217-.56.477-.96.896-1.382.42-.419.822-.679 1.381-.896.422-.164 1.057-.354 2.227-.408 1.264-.061 1.646-.07 4.849-.07z" />
